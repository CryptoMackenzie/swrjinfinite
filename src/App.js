  ...
  return (
    <div>
     ...
     <Roadmap/>*/}
      ...
      <h1 className='text-[#a64af7] font-bold tracking-[10px] text-[2rem] mt-10 mb:mt-0 lg:text-5xl text-center drop-shadow-2xl text-shadow-1 m-1 specialH2'>Features Of Astra Nova</h1>
